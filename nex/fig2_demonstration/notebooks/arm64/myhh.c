...
#define nrn_init _nrn_init__myhh
#define _nrn_initial _nrn_initial__myhh
#define nrn_cur _nrn_cur__myhh
#define _nrn_current _nrn_current__myhh
#define nrn_jacob _nrn_jacob__myhh
#define nrn_state _nrn_state__myhh
#define _net_receive _net_receive__myhh 
#define rates rates__myhh 
#define states states__myhh 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_myhh", _hoc_setdata,
 "rates_myhh", _hoc_rates,
 "vtrap_myhh", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_myhh
 extern double vtrap( _threadargsprotocomma_ double , double );
 /* declare global and static user variables */
 static int _thread1data_inuse = 0;
static double _thread1data[6];
#define _gth 0
#define htau_myhh _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_myhh _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_myhh _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_myhh _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_myhh _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_myhh _thread1data[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 myhh /Users/michaeldeistler/Documents/phd/jaxley_experiments/paper/fig2_demonstration/notebooks/neuron_mechanisms/myhh.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/michaeldeistler/Documents/phd/jaxley_experiments/paper/fig2_demonstration/notebooks/neuron_mechanisms/myhh.mod";
static const char* nmodl_file_text = 
